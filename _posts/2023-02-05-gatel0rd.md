...
Most Recurrent Neural Networks (RNNs) update their latent state in every time step. Is this really necessary? In our NeurIPS 2021 paper we present GateL0RD, an RNN that only sparsely updates its memory. And this brings many benefits, such as better generalization, memory and explainability...
### Abstract
