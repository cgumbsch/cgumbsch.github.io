...
Humans can make predictions on various time scales. Can we give this ability to a recurrent neural network (RNN)? We present a hierarchical RNN that develops temporal abstract predictions - by chopping up time series into segments with constant latent activity...
